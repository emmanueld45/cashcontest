...
if(!isset($_SESSION['id'])){
 $admin->goTo("../auth/login", "typing_contest");
}
?>
...
<head>
    <title>CashContest | Typing contest</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="main-container-middle">
            ...
            <!--=== typing top container start -->
            <div class="sticky-top" style="z-index:100;">
                <div class="cover-container-top">
                    <img src="../contestimages/gameimg3.jpg" class="img">
                </div>

                <div class="cover-container-bottom">
                    <div class="left">
                        <img src="../contestimages/contestimg1.jpg" class="img">
                    </div>
                    <div class="right">
    ...
    <script>
        ...
        function show_join_modal(btn) {
            ...
            $(".contest-url").attr("href", "typing/game.php?contest_id=" + contest_id)
